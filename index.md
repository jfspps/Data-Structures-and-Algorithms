...
## [The stack and the heap](1_Stack_and_Heap.md) ##

## [Essential C and C++](2_Essential_C_and_C++.md) ##
...
## [Classes in C++](3_Classes_in_C++.md) ##
...
## [Types of data structures](4_Types_of_data_structures.md) ##

+ Physical and logical data structures
+ Abstract data types

## [Time and space complexity](5_Time_and_space_complexity.md) ##

+ Order and degree
+ Calling and returning phase of recursive functions
+ Excessive recursions and memoization

## [Recurrence relations and recursion](6_Recurrence_relations.md) ##

+ Designing recursive functions
+ Recurrence relations

## [Static variables and methods](7_Static_variables_and_methods.md) ##

## [Types of recursion](8_Types_of_recursion.md) ##

+ Tail and head recursion
+ Indirect recursion
+ Nested recursion

## [Applications of recursion](9_Recursive_function_applications.md) ##
...
## [Array representations](10_Array_representations.md) ##

+ Static and dynamic arrays
+ Multi-dimensional arrays
+ Row-major and column-major mappings

## [Array operations](11_Array_operations.md) ##
...
## [Array searching](12_SearchingArrays.md) ##

+ Linear search
+ Binary search

## [Algorithm exercises on arrays](13_ArraysExamples.md) ##
...
## [Strings in C and C++](14_Strings.md) ##
...
## [Sparse matrices and polynomials](16_Sparse_matrices_and_Polynomials.md) ##
...
## [Linked Lists](17_LinkedLists.md) ##
...
## [Sparse matrices and polynomials as linked lists](18_Sparse-matrices_and_Linked_lists.md) ##

## [The stack](19_The_Stack.md) ##
...
## [Binary Search Trees BSTs](22_Binary_search_trees.md) ##
...
## [Search trees](24_Search_trees.md) ##
...
## [Binary Heaps](25_Binary_Heaps.md) ##
...
## [Sorting methods](26_Sorting_methods.md) ##
...
## [Hashing techniques](27_Hashing.md) ##
...
## [Exceptions and error-handling](29_Exceptions_and_error_handling.md) ##
